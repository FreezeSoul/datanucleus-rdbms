...
public class MySQLAdapter extends BaseDatastoreAdapter
{
    ...
    public MySQLAdapter(DatabaseMetaData metadata)
    {
        ...
        if (driverName.equalsIgnoreCase("mariadb-jdbc") || driverName.contains("MariaDB"))
        {
            isMariaDB = true;
        }
        ...
        supportedOptions.add(ORDER_BY_IN_UPDATE_STATEMENT); // TODO Does this apply to all version of MySQL, and also to MariaDB?
